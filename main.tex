...
\begin{itemize}
    ...
    \item \href{https://argo-cd.readthedocs.io/en/stable/cli_installation/}{\textbf{argocd}}
\end{itemize}
...
\begin{enumerate}
    ...
    \item \code{cd infra/terraform}
    \item \code{terraform init}
    \item \code{terraform apply -var="aws\_iam\_role=<your LabRole arn>"}
...
\begin{enumerate}
    ...
    \codeblock{kubectl apply -n argocd -f https://raw.githubusercontent.com/argoproj/argo-cd/ stable/manifests/install.yaml}
...
\begin{enumerate}
    ...
    \item Przekieruj aplikację na localhost (zajmuje terminal): \\ \code{kubectl port-forward svc/workflow-api -n default 8081:8080}
    \item Zweryfikuj dostępność za pomocą przeglądarki internetowej
\end{enumerate}
